...
void I2C_Init(I2C_TypeDef *I2Cx, I2C_InitTypeDef *I2C_InitStruct)
{
    ...
    {
        tmpreg =(uint16_t) (i2cPeriod / pclk1Period) / 2;
        I2Cx->IC_SS_SCL_LCNT = tmpreg;
        tmpreg =(uint16_t)( (i2cPeriod - pclk1Period * I2Cx->IC_SS_SCL_LCNT) / pclk1Period);
...
void I2C_GenerateSTOP(I2C_TypeDef *I2Cx, FunctionalState NewState)
{
    ...
    while (I2Cx->IC_ENABLE & 0x02)
        ;
    tempReg =(u8) (I2Cx->IC_CLR_TX_ABRT);
    NewState=NewState;
}
...
{
    uint16_t tmpreg = 0;uint16_t temp;
    /* Check the parameters */
    assert_param(IS_I2C_ALL_PERIPH(I2Cx));
    /* Get the old register value */
    tmpreg =(uint16_t)( I2Cx->IC_TAR);
    /* Reset I2Cx Own address2 bit [7:0] */
    tmpreg &= IC_TAR_Reset;
    /* Set I2Cx Own address2 */
    temp = (uint16_t)(Address >>1);
    tmpreg = temp|tmpreg;
...
void I2C_SendLastDataOrStop(I2C_TypeDef *I2Cx, uint8_t Data)
{
    ...
    assert_param(IS_I2C_ALL_PERIPH(I2Cx));
    /* Write in the IC_DATA_CMD register the data to be sent */
    I2Cx->IC_DATA_CMD = (uint16_t)(0x200 | Data);
}
