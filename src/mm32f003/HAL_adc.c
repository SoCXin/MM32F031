...
void ADC_RegularChannelConfig(ADC_TypeDef *ADCx, uint8_t ADC_Channel, uint8_t Rank, uint8_t ADC_SampleTime)
{
    ...
    tmpreg |=(uint32_t)( ADC_SampleTime << 10);
    ADCx->ADCFG = tmpreg;
    Rank=Rank;
    switch (ADC_Channel)
    {
    ...
    case ADC_Channel_11: 
        ...
        break;
    case ADC_Channel_12: 
        ADCx->ADCHS |= CHEN12_ENABLE;  
        break;
    case ADC_Channel_TempSensor:
        ADCx->ADCHS |= TempSensor_ENABLE; //Temperature Sensor
        break;
    case ADC_Channel_Vrefint:
        ADCx->ADCHS |= Vrefint_ENABLE; //Voltage Sensor
        break;
...
void ADC_AnalogWatchdogSingleChannelConfig(ADC_TypeDef *ADCx, uint8_t ADC_Channel)
{
    ...
    tmpreg |= (uint32_t)(ADC_Channel << 12);
    /* Store the new register value */
    ADCx->ADCR = tmpreg;
}
