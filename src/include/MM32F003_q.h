...
#ifndef __MM32F003_q_H
#define __MM32F003_q_H
...
#define __MM32F003_q_STDPERIPH_VERSION_MAIN   (0x01)                                  
/*!< [15:8]   Standard Peripheral Library sub1 version */
#define __MM32F003_q_STDPERIPH_VERSION_SUB1   (0x00)
/*!< [7:0]   Standard Peripheral Library sub2 version */
#define __MM32F003_q_STDPERIPH_VERSION_SUB2   (0x00) 
/*!< Standard Peripheral Library version number */
#define __MM32F003_q_STDPERIPH_VERSION       ((__MM32F003_q_STDPERIPH_VERSION_MAIN << 16)\
| (__MM32F003_q_STDPERIPH_VERSION_SUB1 << 8)\
  | __MM32F003_q_STDPERIPH_VERSION_SUB2)
...
#define RCC_APB2RSTR_ADC1RST                 ((uint32_t)0x00000200)        /*!< ADC interface reset */
...
#define  RCC_APB1RSTR_SPI2RST                ((uint32_t)0x00004000)        /*!< SPI reset */
...
#define  RCC_AHBENR_DMA1EN                   ((uint32_t)0x00000001)        /*!< DMA clock enable */
...
#define  RCC_APB2ENR_ADC1EN                  ((uint32_t)0x00000200)        /*!< ADC interface clock enable */
...
#define  RCC_APB1ENR_SPI2EN                  ((uint32_t)0x00004000)        /*!< SPI clock enable */
...
#define  RCC_AHBENR_GPIOARST                 ((uint32_t)0x00020000)        /*!< GPIOA clock enable */
#define  RCC_AHBENR_GPIOBRST                 ((uint32_t)0x00040000)        /*!< GPIOB clock enable */
#define  RCC_AHBENR_GPIOCRST                 ((uint32_t)0x00080000)        /*!< GPIOC clock enable */
#define  RCC_AHBENR_GPIODRST                 ((uint32_t)0x00100000)        /*!< GPIOD clock enable */
...
#define  ADCR_TRGSEL                          ((uint32_t)0x00060070)               /*!<TRGSEL[6:4][18:17] ADC external trigger source select */
...
#define  ADCR_TRGSEL_TIM1_CC1_CC5             ((uint32_t)0x00000050)               /*!<TIM1_CC1 and CC5 as trig source*/
...
/*******************  Bit definition for TIM_CCR4 register  *******************/
#define  TIM_CCR4_CCR5                       ((uint16_t)0xFFFF)            /*!<Capture/Compare 5 Value */
